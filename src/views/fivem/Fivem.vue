<template>
  <div id="app">
    <transition name="fade">
        <img :class="{logo_main:useMain,logo_main_game:useFivem}" src="../../assets/quantum.png" alt="">
    </transition>
    <transition name="fade">
    ...
    <transition name="fade">
        <index @Lobby="Lobby" :Fivem="useFivem" :Main="useMain"/>
    </transition>
    <transition name="fade">
        <index2 :Fivem="useFivem" :Main="useMain"/>
    </transition>
  </div>
</template>

<script>
import index from "../../components/fivem/index.vue"
import index2 from "../../components/main/Minecraft.vue"
...
export default {
  ...
  methods: {
    ...
    track () {
      this.$gtag.pageview({ page_path: '/Quantum-Fivem' })
      
      this.$gtag.pageview('/Quantum-Fivem')
